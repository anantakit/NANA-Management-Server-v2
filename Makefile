.PHONY: dev build run migrate seed test test-integration test-integration-setup lint clean \
       smoke-settlement smoke-settlement-legacy smoke-settlement-all smoke-draft smoke-moveout-step23 smoke-moveout-step4 smoke-all smoke-install
...
smoke-all:
	cd devtools/smoke && node playwright-test-settlement-preview-legacy.js && node playwright-test-settlement-scenario-smoke.js && node playwright-test-draft-settlement-smoke.js && node playwright-test-moveout-step23-smoke.js && node playwright-test-moveout-step4-smoke.js
