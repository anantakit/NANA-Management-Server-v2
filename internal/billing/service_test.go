...
// ============================================================
// Batch Monthly Billing Tests have moved to
// internal/billing/monthly/ (commit 2b — monthly workflow extraction).
// Only TestBatch_ComputeStatus below remains here because it tests a
// domain method on BillGenerationBatch, which stays in the billing root
// package alongside the batch repo.
// ============================================================
